...
# folder create ================================================
path_output_dir = "PersonA/PathPlanning_outputs/TC03_outputs/path_outputs"
os.makedirs(path_output_dir, exist_ok = True)

Homography_output_dir = "PersonA/PathPlanning_outputs/TC03_outputs/Homography_outputs"
os.makedirs(Homography_output_dir, exist_ok = True)

YOLO_output_dir = "PersonA/PathPlanning_outputs/TC03_outputs/YOLO_outputs"
...
# cvs에 박스 좌표 저장
csv_path = "PersonA/PathPlanning_outputs/TC03_outputs/YOLO_outputs/detections_xyxy.csv"
with open(csv_path, "w", newline="") as f :
    ...
    for key, img_path in cam_frames.items() :
        ...
        out_img_path = f"PersonA/PathPlanning_outputs/TC03_outputs/YOLO_outputs/TC03_{key}_annotated.png"
...
with open("PersonA/PathPlanning_outputs/TC03_outputs/Homography_outputs/H_iw2.json", "w") as f :
...
print(" ")
print(" 📌 Saved in 'PersonA/PathPlanning_outputs/TC03_outputs/Homography_outputs' ")
print(" ")
...
GRID_CFG = {
    "ORIGIN_W": np.array([2700, 4500], dtype=float), 
    "RES_MM": 450.0,            
...
def _plot_grid_result(matrix, paths, start, dest) :
    ...
    plt.savefig("PersonA/PathPlanning_outputs/TC03_outputs/path_outputs/final_astar_result.png", dpi = 300, bbox_inches="tight")
    plt.show()
...
if __name__ == "__main__" :
    ...
    print(" ")
    print(" 📌 Saved in 'PersonA/PathPlanning_outputs/TC03_outputs/path_outputs/final_astar_result.png' ")
    print(" ")
    ...
    # ✅ 경로 CSV 저장
    path_csv_path = "PersonA/PathPlanning_outputs/TC03_outputs/path_outputs/final_path.csv"
    ...
    # ✅ 경로 JSON 저장
    path_json_path = "PersonA/PathPlanning_outputs/TC03_outputs/path_outputs/final_path.json"
