...
cam_frames = {
   "cam51" : "PersonA/Test_frames/cam_no_1.png",
   "cam52" : "PersonA/Test_frames/cam_no_2.png",
   "cam53" : "PersonA/Test_frames/cam_no_3.png",
   "cam54" : "PersonA/Test_frames/cam_no_4.png"
}

model = YOLO("yolov10n.pt")
os.makedirs("PersonA/PathPlanning_outputs/YOLO_outputs", exist_ok = True)

# cvs에 박스 좌표 저장
csv_path = "PersonA/PathPlanning_outputs/YOLO_outputs/detections_xyxy.csv"
with open(csv_path, "w", newline="") as f :
    ...
    for key, img_path in cam_frames.items() :
        ...
        out_img_path = f"PersonA/PathPlanning_outputs/YOLO_outputs/{key}_annotated.png"
...
with open("PersonA/PathPlanning_outputs/Homography_outputs/H_iw2.json", "w") as f :
...
print(" ")
print(" 📌 Saved in 'PersonA/PathPlanning_outputs/Homography_outputs' ")
print(" ")
...
def _plot_grid_result(matrix, paths, start, dest) :
    ...
    plt.savefig("PersonA/PathPlanning_outputs/path_outputs/final_astar_result.png", dpi = 300, bbox_inches="tight")
    plt.show()
...
if __name__ == "__main__" :
    ...
    os.makedirs("PersonA/PathPlanning_outputs/path_outputs", exist_ok = True)
    plt.close()

    print(" ")
    print(" 📌 Saved in 'PersonA/PathPlanning_outputs/path_outputs/final_astar_result.png' ")
    print(" ")
    ...
    # ✅ 경로 CSV 저장
    path_csv_path = "PersonA/PathPlanning_outputs/path_outputs/final_path.csv"
    ...
    # ✅ 경로 JSON 저장
    path_json_path = "PersonA/PathPlanning_outputs/path_outputs/final_path.json"
